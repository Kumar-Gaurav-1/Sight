...
@MainActor struct SightBreaksView: View {
...
@MainActor struct SoundSettingRow: View {
    let title: String
    let subtitle: String
    let icon: String
    let iconColor: Color
...
@MainActor struct IntervalCard: View {
    let title: String
    let subtitle: String
    let value: Int
    let unit: String
...
@MainActor struct SkipDifficultyCard: View {
...
@MainActor struct InfoCard: View {
    let icon: String
    let text: String
    let color: Color
