...
public @MainActor struct SightPreferencesView: View {
...
private @MainActor struct SidebarItem: View {
    let tab: SettingsTab
    let isSelected: Bool
    let isHovered: Bool
...
private @MainActor struct GeneralSettingsView: View {
...
private @MainActor struct BreaksSettingsView: View {
    @ObservedObject var prefs = PreferencesManager.shared
...
private @MainActor struct WellnessSettingsView: View {
    @ObservedObject var prefs = PreferencesManager.shared
...
private @MainActor struct SoundsSettingsView: View {
    @ObservedObject var prefs = PreferencesManager.shared
...
private @MainActor struct AppearanceSettingsView: View {
    @ObservedObject var prefs = PreferencesManager.shared
...
private @MainActor struct PositionButton: View {
    let position: String
    let label: String
    let current: String
    let action: () -> Void
...
private @MainActor struct ShortcutsSettingsView: View {
    var body: some View {
        Form {
            Section {
                ShortcutRow(
...
private @MainActor struct AboutSettingsView: View {
