...
**Learning:** Found multiple instances where ISO8601DateFormatter was being instantiated inside  closures (AdherenceManager, RuntimeProfiler), causing O(N) expensive allocations.
